...
public class Flight {
    ...
    public Flight (String airline, String flightNo, Date departureTime, Date arrivalTime, String departureDest, String arrivalDest, String airport,int price, int seatAvailability) {
        this.airlineNo = airline;
